...
@Entity("appDiscoverAppI18n")
@Table("wal_app_discover_app_i18n")
@TableDef(comment = "app I18n表", indexes = @IndexesUnion(
        unique = {@UniqueUnion(fields = {"appId", "language"})}
))
public class AppDiscoverAppI18n extends DiscoverI18nBase {

    private static final long serialVersionUID = 1L;

    public AppDiscoverAppI18n() {
    }
