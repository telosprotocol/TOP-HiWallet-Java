...
@Entity("appDiscoverDappI18n")
@Table("wal_app_discover_dapp_i18n")
@TableDef(comment = "dapp I18n表", indexes = @IndexesUnion(
        unique = {@UniqueUnion(fields = {"appId", "language"})}
))
public class AppDiscoverDappI18n extends DiscoverI18nBase {

    private static final long serialVersionUID = 1L;

    public AppDiscoverDappI18n() {
    }
